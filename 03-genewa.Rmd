...
As described in Section \@ref(intro-gwas), genome-wide association studies 
(GWAS) aim at quantifying how single-nucleotide polymorphisms (SNPs) predispose 
to complex diseases, like diabetes or some forms of cancer [@bush_chapter_2012]. 
Despite their successes [@buniello_nhgri-ebi_2019], GWAS also presents intrinsic
challenges (Section \@ref(intro-gwas-challenges)). Some of them stem from the
