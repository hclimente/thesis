...
With the intention of applying SConES to the GENESIS dataset, I started working on a user-friendly version. The result was an R package, /martini/, which is published with Bioconductor 3.7. Bioconductor is a peer-reviewed R repository. /martini/ is based on EasyGWAS' implementation of SConES [@grimm_easygwas:_2017]. Hence, it combines the accessibility of R and and the Bioconductor environment with the computational efficiency of C++.
