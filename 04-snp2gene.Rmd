...
For instance, we want to know if two interacting SNPs alter the same gene, and
buth alterations are required to modify its function; or if they affect 
different genes that participate in the same pathway, or n two pathways that 
cross-talk.
